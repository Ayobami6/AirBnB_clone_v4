$(document).ready(function () {
  ...
  // task 7
  const $reviewSpan = $("h2.reviews + span");
  const $reviewContainer = $("div.reviews-container");

  function fetchDisplayReviews() {
    $.ajax({
      ...
      success: function (reviews) {
        reviews.forEach((review) => {
          const $reviewContent = $("<div></div>").text(review.content);
